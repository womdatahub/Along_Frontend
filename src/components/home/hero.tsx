      ...
      >
        ...
        <div className="flex flex-col  justify-center gap-6 md:gap-16 px-4 md:px-0 max-w-7xl mx-auto text-center w-full mt-24">
          ...
          <div className="flex gap-4 flex-col text-left md:ml-10 z-10">
            ...
            <div className="flex bg-white rounded-lg overflow-hidden gap-2 md:gap-8 justify-between text-black pl-2 md:pl-8">
              <div className="flex gap-2 md:gap-8 flex-1">
                <div className="self-center">
                  <LocationIcon />
                </div>
                <div className="flex-1 pt-3 outline-none text-gray-700 min-w-1/2 md:max-w-1/2">
                  <RadarAutocomplete
              ...
              <CompleteHeroServiceDialog
                trigger={
                  <Button className="g-primary px-6 md:px-6 py-5 md:py-6 w-fit h-full rounded-l-none md:w-40 text-white text-base md:text-2xl hover:bg-teal-700 hover:cursor-pointer transition-colors duration-500">
                    Go
                  </Button>
                }
              />
