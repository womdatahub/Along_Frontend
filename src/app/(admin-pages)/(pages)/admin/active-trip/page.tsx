    ...
    <section className='flex flex-col gap-8'>
      ...
      <div className='flex flex-col md:flex-row gap-7'>
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex gap-4 flex-row md:flex-col overflow-x-scroll'>
            {trips.map((trip, id) => (
              <Card
                key={id}
                className={cn(
                  "min-w-[250px] md:w-[350px] rounded-2xl shadow-none border",
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-start gap-4 rounded-2xl border p-5'>
                  <div className='flex-1'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-4 gap-y-2 gap-x-4 mt-4 text-sm'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-start gap-4 rounded-2xl border p-5'>
                  <div className='flex-1'>
                    ...
                    <div className='flex flex-col md:flex-row gap-2 md:gap-10 mt-4 text-sm'>
                      <div className='flex md:flex-col gap-1'>
                        <p className='text-gray-400 font-medium text-xs'>
                          Phone number
                        </p>
