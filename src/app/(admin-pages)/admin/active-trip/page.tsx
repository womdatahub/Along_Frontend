...
const Page = () => {
  return (
    <section className='flex flex-col gap-8'>
      ...
      <Card className='w-full md:w-[422px] rounded-2xl shadow-none border-0'>
        <CardContent className='flex flex-col gap-3 px-0'>
          <div className='font-heebo flex justify-between items-center font-semibold text-sm text-primary px-4'>
            <p>Scheduled Trip</p>
            <p className='text-black text-xs'>Trip ID: 109934</p>
          </div>
          ...
          <div className='flex gap-4 justify-between items-center px-4 mt-6 pt-4 border-t-2'>
            ...
            <p className='font-heebo font-semibold text-xs'>Economy</p>
          </div>
        </CardContent>
      </Card>
    </section>
