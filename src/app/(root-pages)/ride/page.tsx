            ...
            <div className='flex flex-col gap-2 w-1/2'>
              ...
              <div className='flex flex-col gap-6'>
                ...
                <p className='font-heebo font-light text-lg text-left'>
                  ...
                  Vans. Drivers are vetted, professional and friendly.
                    ...
                    >
                      ...
                      <div className='flex flex-col gap-6'>
                        <div className='flex flex-col pl-7'>
                          ...
                          <p className='text-sm'>
                            Please select a ride rental option to continue{" "}
                            <br />
                            your booking
                          </p>
                        </div>
                                ...
                                >
                                  ...
                                  <div className='flex flex-col gap-6'>
                                    <div className='flex flex-col pl-7'>
                                      ...
                                      <p className='text-sm'>
                                        Please select a vehicle option to
                                        continue <br /> your booking
                                      </p>
                                    </div>
                                    <div className='flex flex-col gap-1'>
                                      {carTypes.map((car) => {
