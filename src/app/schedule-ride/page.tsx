...
const Page = () => {
  ...
  const [pickUpAutoCompleteAddress, setPickUpAutoCompleteAddress] = useState<
    AddressResult | undefined
  >(undefined);
  const [destinationAutoCompleteAddress, setDestinationAutoCompleteAddress] =
    useState<AddressResult | undefined>(undefined);
  console.log(
    "autoCompleteAddress",
    pickUpAutoCompleteAddress,
    destinationAutoCompleteAddress
  );
  return (
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-4 bg-white rounded-2xl justify-between w-full px-6 py-6">
                  <div className="flex gap-4 items-center border-b pb-4">
                    <PickupAddressIcon />
                    <RadarAutocomplete
                      setAutoCompleteAddress={setPickUpAutoCompleteAddress}
                  ...
                  <div className="flex gap-4 items-center">
                    <DestinationAddressIcon />
                    <RadarAutocomplete
                      setAutoCompleteAddress={setDestinationAutoCompleteAddress}
