...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-10 rounded-[20px] w-125 px-8 py-10 bg-white text-black">
      ...
      <div className="flex flex-col gap-8">
        <AddInput
          ...
          required
          type="text"
          iconAndInputWrapperClassName="bg-background rounded-2xl h-16"
      ...
      <div className="flex flex-col gap-8 mt-5 text-center">
        ...
        <div className="flex gap-5">
          <UploadingImagesReusableComponent
            ...
            className="justify-center items-center rounded-[10px] bg-background text-placeholder self-end w-full h-20"
